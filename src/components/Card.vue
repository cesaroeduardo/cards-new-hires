<template>
  <div
    class="w-[185px] h-[285px] md:w-[223px] md:h-[300px] text-white rounded-lg transform transition-transform duration-500 ease-in-out cursor-pointer perspective mx-2 my-2 card3d"
    @click="toggleFlip"
